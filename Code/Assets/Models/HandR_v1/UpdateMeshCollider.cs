...
public class UpdateMeshCollider : MonoBehaviour
{
    ...
    //void Update()
    //{
    //     _skinnedMeshRenderer.BakeMesh(_meshCollider.sharedMesh);
    //}
    ...
    void Start()
    {
        UnityEngine.Debug.Log("update mesh collider");
        ...
        if (collide != null && rend != null)
        {
            ...
            UnityEngine.Debug.Log("update mesh collider vertices " + mesh.vertices[0]);
